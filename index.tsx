...
const App = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Use smaller threshold for smoother trigger at the top
  ...
  const aiSolutions = [
    {
      title: "Мультимодальный RAG: Оцифровка данных",
      category: "AI Learning / RAG",
      desc: "Создание 'цифрового двойника' знаний. Система обучается на любых экспертных материалах: от бизнес-литературы до сложной технической документации.",
      image: "/book.jpeg",
      icon: <Brain size={24} />
    },
    {
  ...
  return (
    <div className="min-h-screen relative text-slate-200 bg-slate-950 selection:bg-indigo-500 selection:text-white">
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${scrolled ? "bg-slate-950/80 backdrop-blur-md py-4 border-b border-white/10 shadow-lg" : "bg-transparent py-6 border-b border-transparent shadow-none"}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
      ...
      <section className="py-24 px-6 bg-slate-950 relative border-t border-slate-800 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400">Реальные проекты, созданные нашими руками</p>
          </div>
